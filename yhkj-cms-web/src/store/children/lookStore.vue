        ...
        <div class="content-box-input">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="" prop="region">
              <el-select v-model="ruleForm.franchiser" placeholder="请选择加盟商" :disabled="true">
            ...
            <el-form-item label="价格档：" prop="price">
              <el-select v-model="ruleForm.price" placeholder="请选择" :disabled="true">
            ...
            <el-row>
              <el-form-item label="门店全称：" prop="fulName">
                <el-col :span="6"><el-input v-model="ruleForm.fulName" maxlength="20" :disabled="true"></el-input></el-col><el-col :span="4">最多输入20个字</el-col>
              </el-form-item>
            </el-row>
            <el-row>
              <el-form-item label="门店简称：" prop="abbName">
                <el-col :span="6"><el-input v-model="ruleForm.abbName" :disabled="true"></el-input></el-col><el-col :span="4">最多输入10个字</el-col>
              </el-form-item>
            </el-row>
            ...
            <el-form-item label="门店位置：" prop="positionName">
              <el-col :span="6">
                <el-input v-model="ruleForm.positionName" :disabled="true"></el-input>
              </el-col>
              <el-col :span="6">
                <el-input v-model="ruleForm.positionName" :disabled="true"></el-input>
              </el-col>

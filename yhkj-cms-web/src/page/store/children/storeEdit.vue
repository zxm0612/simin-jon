          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            <el-form-item label="门店性质" prop="type">
              <el-radio-group v-model="ruleForm.type">
                <el-radio v-model="ruleForm.type" label="1"  @change="storeStatus(1)" disabled="true">直营</el-radio>
                <el-radio v-model="ruleForm.type" label="2"  @change="storeStatus(2)" disabled="true">加盟</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="" prop="businessName">
              <el-select v-model="ruleForm.businessName" placeholder="请选择加盟商" v-show="pageStatus">
                <el-option  v-for="item in this.franchiseeInfo" :label="item.name" :value="item.name" :key="item.name"></el-option>
              </el-select>
            </el-form-item>
              ...
              <div class="store-album">
                <ul>
                  ...
                  <li v-for="item in ruleForm.imageList" :key="item">
                    <img :src="item">
                    <span><i @click="isCover(item)">设为封面</i><em>删除图片</em></span>
                  </li>
                </ul>
              </div>
            </el-form-item>
            ...
            <el-form-item label="开店时间：" required>
              <el-form-item prop="openDate">
                <el-date-picker type="date" placeholder="选择日期" v-model="ruleForm.openDate" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd hh:mm:ss" disabled="true"></el-date-picker>
              </el-form-item>
            </el-form-item>
            <el-form-item>
...
<script>
  ...
  import {mendianModify} from "../../../service/getData";
    ...
    methods: {
      ...
      async submitForm() {
        ...
        if(this.$route.params.mode === 'edit'){
          ...
          let status = await mendianModify(
            this.ruleForm.id,
